...
// New function to handle JSON export
function exportToJson(editor: LexicalEditor) {
  ...
  link.href = url;
  link.download = `EditorState_${new Date().toISOString()}.json`;
  ...
  return (
    <div className="actions">
      ...
      <button
        ...
        aria-label="Export editor state as JSON file"
      >
        <i className="export-json" />
      </button>
      <button
